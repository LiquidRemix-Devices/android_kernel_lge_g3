 ...
 *           2.2 - Ported to LG G3 By Eliminater74 (eliminater74@gmail.com) 08/09/2015
 *
 */
...
MODULE_DESCRIPTION("'cpufreq_arteractive' - A cpufreq governor for "
	"Latency sensitive workloads based on Samsung's Galaxy S5 Interactive: Ported over to G3");
MODULE_LICENSE("GPL");
